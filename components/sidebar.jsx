...
const Sidebar = () => {
  ...
  const [selectedDeleteHistoryId, setSelectedDeleteHistoryId] = useState("")
  ...
  const deleteHistoryById = async (session_id) => {
    try {
      ...
      setSelectedDeleteHistoryId(session_id)
      ...
      // historyFetchById(sessionId, userId)
      setAnswers([])
      setQuestion("")
    }
  }
                ...
                <div className="mx-2">
                  ...
                  {historyData[date].map((session, index) => (
                    ...
                    >
                      ...
                      >
                        {isDeleteLoading &&
                        session.session_id === selectedDeleteHistoryId ? (
                          <div
          ...
          <div className="mt-auto">
            ...
            <div>
              ...
              <div className="pt-10 pb-8 ps-4 text-white">
                {/* <Link
                  href="https://lawkey.co.in"
                  className="flex items-center pb-4 font-bold hover:scale-105 duration-300"
                >
                  Go To LawKey
                </Link> */}
